$(function () {
    $("#bt-sign-in").on("click", function() {
        ...
        if (username === "user@email.com" && password === "password") {
            ...
            $("<span id=\"empty-field-msg\"><p>Please, provide username and password!</p></span>").appendTo("#message");
        } else {
            $("<span id=\"error-msg\"><p>Invalid username and/or password!</p></span>").appendTo("#message");
        }
    });
});
